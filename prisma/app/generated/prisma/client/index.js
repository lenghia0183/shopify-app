...
const config = {
  "generator": {
    ...
    "output": {
      "value": "D:\\Reactjs\\shopify-app\\prisma\\app\\generated\\prisma\\client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "D:\\Reactjs\\shopify-app\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"app/generated/prisma/client\"\n}\n\n// Note that some adapters may set a maximum length for the String type by default, please ensure your strings are long\n// enough when changing adapters.\n// See https://www.prisma.io/docs/orm/reference/prisma-schema-reference#string for more information\ndatasource db {\n  provider = \"sqlite\"\n  url      = \"file:dev.sqlite\"\n}\n\nmodel Session {\n  id            String    @id\n  shop          String\n  state         String\n  isOnline      Boolean   @default(false)\n  scope         String?\n  expires       DateTime?\n  accessToken   String\n  userId        BigInt?\n  firstName     String?\n  lastName      String?\n  email         String?\n  accountOwner  Boolean   @default(false)\n  locale        String?\n  collaborator  Boolean?  @default(false)\n  emailVerified Boolean?  @default(false)\n}\n\nmodel PricingRule {\n  id               String   @id @default(uuid())\n  name             String\n  priority         Int\n  status           String\n  applyTo          String // Stored as JSON array\n  priceType        String // Stored as JSON array\n  priceValue       String\n  productTags      String? // Stored as JSON array\n  selectedProducts String? // Stored as JSON array\n  collections      String? // Stored as JSON array\n  createdAt        DateTime @default(now())\n  updatedAt        DateTime @updatedAt\n}\n",
  "inlineSchemaHash": "cdfab569a8e4b9755487ea4599b37347d4b0e7a94f59c84586e0c0a40f62bc66",
  "copyEngine": true
}
